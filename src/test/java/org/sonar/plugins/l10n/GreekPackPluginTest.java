...
public class GreekPackPluginTest {
  ...
  public void coreBundleShouldBeUpToDate() {
    assertThat("core_el.properties", isBundleUpToDate(SONAR_VERSION));
  }

  @Test
  public void gwtBundleShouldBeUpToDate() {
    assertThat("gwt_el.properties", isBundleUpToDate(SONAR_VERSION));
  }

  @Test
  public void squidJavaBundleShouldBeUpToDate() {
    assertThat("squidjava_el.properties", isBundleUpToDate(SONAR_VERSION));
  }
